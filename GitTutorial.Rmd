---
title: "The No Shell (Maybe*) Git/GitHub Tutorial for R users"
...
1. Check the `r emo::ji("ballot_box_with_check")`"Initialize this repository with a README" box 

1. Check the [x]"Initialize this repository with a README" box 
